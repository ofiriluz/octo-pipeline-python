...
class PIPEnvPythonCommandsModel(BaseModel):
    ...
    working_dir: Optional[str] = Field(default=None, description="Working dir for executing commands")
...
class PIPEnvModel(BaseModel):
    ...
    venv_path: Optional[str] = Field(default=None, description="Venv path to activate for")
    pipenv_path: Optional[str] = Field(default=None, description="Path to pipenv files")
