...
from octo_pipeline_python.backends.pipenv.actions import (PIPEnvActivate,
                                                          PIPEnvConsume,
                                                          PIPEnvExecute)
...
class PIPEnvBackend(Backend):
    def __init__(self) -> None:
        self.__actions = {
            ActionType.Activate: PIPEnvActivate(),
            ActionType.Consume: PIPEnvConsume(),
            ActionType.Execute: PIPEnvExecute(),
        }
