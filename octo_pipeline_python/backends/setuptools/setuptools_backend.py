...
from octo_pipeline_python.backends.setuptools.actions import SetupToolsPackage
...
class SetupToolsBackend(Backend):
    def __init__(self) -> None:
        self.__actions = {
            ActionType.Package: SetupToolsPackage()
        }
